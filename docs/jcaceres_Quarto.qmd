...
This section demonstrates how meteorological variables are processed and linked to air-quality observations using R. Hourly records from the Madrid Open Data Portal are reshaped, validated, and aggregated into daily means before being joined with NO₂ and O₃ concentrations.
